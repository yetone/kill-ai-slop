...
**[killaislop.com](https://killaislop.com)** into action: it detects 30 tells
...
tiles, kickers over every heading, full-sentence display headlines, springy
hover effects, all-caps stat-card grids, invented stat rows, 01/02/03 section
markers, cards nested in cards, the default Inter/Space Grotesk look, and the
"tasteful terminal" default. It works across HTML/CSS, React/Vue/Svelte/Astro,
Tailwind, and Markdown copy.
